...
let songIndex = 0;
let audioElement = new Audio('public/song/tlop/Father Stretch My Hands Pt. 1.mp3');
let masterPlay = document.getElementById('masterPlay');
let myProgressBar = document.getElementById('myProgressBar');
let gif = document.getElementById('gif');
let masterSongName = document.getElementById('masterSongName');
let songItems = Array.from(document.getElementsByClassName('songItem'));
console.table(songItems)

let songs = [
    { songName: "Father Stretch My Hands Pt. 1", filePath: "public/song/tlop/Father Stretch My Hands Pt. 1.mp3", coverPath: "public/images/altlop.jpg" },
    { songName: "Famous", filePath: "public/song/tlop/Famous.mp3", coverPath: "public/images/altlop.jpg" },
    { songName: "No More Parties In Live", filePath: "public/song/tlop/No More Parties In LA.mp3", coverPath: "public/images/altlop.jpg" },
    { songName: "Sain Pablo", filePath: "public/song/tlop/Saint Pablo.mp3", coverPath: "public/images/altlop.jpg" },
];
